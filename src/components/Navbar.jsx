  ...
  return (
    <nav className='h-max flex justify-between items-center w-[85%] mx-auto py-1'>
      {/* queda pendiente el buscar como retornar a secciones especificas con el navbar */}
        ...
        <label htmlFor="menu" className='z-50 bg-[url(public/menu-burger.png)] peer-checked:bg-[url(public/cross-small.png)] peer-checked:w-9 transition-all w-7 h-7 bg-no-repeat bg-center bg-cover cursor-pointer md:hidden'></label>
