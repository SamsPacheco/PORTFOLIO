...
export const ContactMe = () => {
  return (
    <main className='md:w-[85%] h-max py-1  mx-auto'>
        ...
        <section className='h-max rounded-md mx-auto bg space-y-5'>
            ...
            <form className='px-10 bg-transparent space-y-3 mx-auto'>
              ...
              <div className='flex justify-center border border-[#acacac] py-1 rounded-md gap-1 px-1'>
                ...
                <textarea type="text" rows={5} placeholder='Your Message' className='w-full text-white placeholder:px-2 focus:outline-none not-placeholder-shown:bg-transparent group-[input:-webkit-autofill]:bg-transparent' />
              </div>
                ...
                <button className='md:py-3 w-full mx-auto md:w-[200px] bg-linear-to-bl from-violet-500 to-fuchsia-500 py-2 rounded-md flex items-center justify-center gap-3 cursor-pointer text-white font-semibold my-5'>
                  <img src="public/paper-plane.png" alt="paper-plane-icon" className='w-5' />
                  Send Message
                </button>
